...
_**Brief:** LibreWolf is a Firefox fork that focuses on privacy and security by eliminating telemetry and adding other perks. Let us find out more about it._
...
Unlike other Firefox forks (for instance- [Basilisk browser][2]), it is regularly updated. And, it only focuses on providing a private web experience without affecting the user experience you’d expect with Mozilla Firefox.
...
You can refer to our guide on [using AppImage][6] and the [resource on Flatpak][7], in case you didn’t know.

It is also available in [Arch User Repository (AUR)][8] for Arch Linux users.

You can find other installation instructions on their [official][9] [][9][website][9] or its [GitLab page][10].
