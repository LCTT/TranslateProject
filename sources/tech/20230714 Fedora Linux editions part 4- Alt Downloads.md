...
![Fedora Linux editions part 4 Alt Downloads][1]
...
Don’t confuse this with network booting which is a method of initiating an operating system or operating system installer from a small [Preboot Execution Environment][5]. (Though it is possible for that sort of [bootloader][6] to [chain-load][7] Fedora’s network installer.)
...
After I wrote my initial post in this series that introduced the main Fedora Linux editions, [Fedora Cloud was restored to full edition status][8]. There are still some links to the Fedora Cloud images on the Fedora Alt Downloads page. But they will be removed soon. The correct place to get the latest Fedora Cloud images is now <https://fedoraproject.org/cloud/download/>.
...
[1]: https://fedoramagazine.org/wp-content/uploads/2023/03/FedoraMagz-FedoraEditions-4-Alt-Downloads-816x345.png
...
[6]: https://en.wikipedia.org/wiki/Bootloader
[7]: https://en.wikipedia.org/wiki/Chain_loading
[8]: https://fedoraproject.org/wiki/Changes/RestoreCloudEdition
