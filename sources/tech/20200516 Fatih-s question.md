...
[3]: tmp.TaEWGiQkTS#easy-footnote-bottom-1-4153 (This does not violate the <em>everything is a copy</em> rule, a copy of a pointer to <code>main.v</code> still points to <code>main.v</code>.)
[4]: tmp.TaEWGiQkTS#easy-footnote-1-4153
