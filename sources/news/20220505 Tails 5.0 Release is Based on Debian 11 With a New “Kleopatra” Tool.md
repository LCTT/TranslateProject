...
======
Tails 5.0 is an impressive upgrade with Debian 11 and a new tool to equip users with enhanced security and privacy.

![tals 5.0][1]

Tails is a popular Linux distribution that focuses on protecting against censorship and surveillance. It is one of the [privacy-focused Linux distributions][2].

Without worrying about exposing your information, you can use it anywhere using a USB stick and get your work done.

Its latest release, Tails 5.0, utilizes Debian 11 (Bullseye) as its base. So, you should expect all the [improvements in Debian 11][3] in Tails 5.0.
...
Kleopatra is a graphical interface to [GnuPG][5] to help encrypt text and files. With Tails 5.0, Kleopatra replaces *OpenPGP* Applet and the *Seahorse* utility.
...
In addition to all this, you also get numerous fixes. You can explore more about it in its [official release announcement][7].
...
[1]: https://news.itsfoss.com/wp-content/uploads/2022/05/tail-5-0-release.jpg
[2]: https://itsfoss.com/privacy-focused-linux-distributions/
[3]: https://news.itsfoss.com/debian-11-feature/
[4]: https://news.itsfoss.com/wp-content/uploads/2022/05/kleopatra.png
[5]: https://www.gnupg.org/
[6]: https://news.itsfoss.com/wp-content/uploads/2022/05/desktop-tails-5.png
[7]: https://tails.boum.org/news/version_5.0/index.en.html
