...
While there are some differences between the [Raspberry Pi Zero vs. Raspberry Pi Zero W][1], both were pretty solid deals considering they launched for $5 and $10, respectively.

Now, Raspberry Pi has unveiled the successor to this lineup after about six years, i.e., Raspberry Pi Zero 2 W priced at **$15**.

Even with [Raspberry Pi increasing its price][2], I’d say $15 for a new-gen board for improved multi-threaded performance should be a good buy.
...
As per the [official announcement][6], Raspberry Pi mentions:

> The exact performance uplift over Zero varies across workloads, but for multi-threaded [sysbench][7] it is almost exactly five times faster.

The tiny form factor and the performance uplift should make it an ideal board for security cameras and many other IoT projects. You may take a look at our list of [DIY projects for Raspberry Pi Zero W][8] for ideas.
...
[4]: data:image/svg+xml;base64,PHN2ZyBoZWlnaHQ9IjUxMCIgd2lkdGg9Ijc4MCIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIiB2ZXJzaW9uPSIxLjEiLz4=
[5]: https://i0.wp.com/i.ytimg.com/vi/V2frBYX62LU/hqdefault.jpg?w=780&ssl=1
...
[9]: data:image/svg+xml;base64,PHN2ZyBoZWlnaHQ9IjUyMSIgd2lkdGg9Ijc4MCIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIiB2ZXJzaW9uPSIxLjEiLz4=
[10]: data:image/svg+xml;base64,PHN2ZyBoZWlnaHQ9IjUyMCIgd2lkdGg9Ijc4MCIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIiB2ZXJzaW9uPSIxLjEiLz4=
