...
Three months after the [last kernel release][1], Linux Kernel 5.19 is finally here. This exciting release brings plenty of improvements to every aspect of the kernel and opens up opportunities with new hardware.
...
Don’t get your pitchfork out just yet. Torvalds used [Asahi Linux][2], a project dedicated to adding Linux support to Apple’s Arm-based Silicon Macbooks.
...
That’s interesting. And this is the [third time][3] Torvalds used Apple hardware for Linux development.
...
In addition to the ones I mentioned above, Linux Kernel 5.19 also includes
  ...
  * Performance optimizations as reported by [Phoronix][4].
...
So, if you are feeling adventurous (and know what you are doing), you can find the newer kernel listed on [Linux Kernel Archives][5]. You can download the [tarball][6] to test it out.
...
[1]: https://news.itsfoss.com/linux-kernel-5-18-release/
[2]: https://news.itsfoss.com/asahi-linux-alpha/
[3]: https://lore.kernel.org/lkml/CAHk-=wgrz5BBk=rCz7W28Fj_o02s0Xi0OEQ3H1uQgOdFvHgx0w@mail.gmail.com/T/#u
[4]: https://www.phoronix.com/news/Linux-5.19-Features
[5]: https://www.kernel.org/
[6]: https://git.kernel.org/torvalds/t/linux-5.19.tar.gz
