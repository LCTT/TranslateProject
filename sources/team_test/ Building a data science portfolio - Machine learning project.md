...
> 这是[这个系列][3]发布的第三篇关于如何取得数据科学方面的综合能力（Data Science Portfolio）的文章。如果你喜欢这个系列并且想继续关注，你可以在订阅页面的底部找到[链接][1]。

数据科学公司在决定雇佣时越来越关注你在数据科学方面的综合能力（Portfolio）。这其中的一个原因是，这样的综合能力是最好的判断某人的实际技能的方法。好消息是取得这样的综合能力完全要看你自己。只要你在这方面付出了努力，你一定可以取得让这些公司钦佩的综合能力。
