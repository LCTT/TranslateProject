...
先前，我将大量的责任归咎于冒充综合症，因为这延迟了我的第一个开源贡献。但还有一个我无法忽视的因素：我无法做决定来拯救我的生活。在成千上百万的开源项目中抉择时，选择一个要做贡献的项目势不可挡。如此压迫以至于我常常不得不关掉我的笔记本去思考：“或许我可以改天再做一次”。
...
在选择我的项目时，我有自信有人会查看我编写的代码。当然，我也希望阅读我代码的人心怀善意。毕竟，将自己的作品放在那里让公众审查是很恐怖。虽然我对建设性的反馈持开放态度，但我希望能避免开发者社区中的阴暗角落。

为了评估我将加入的社区，我查看了repos的提问部分。我想看看核心团队中是否有人在定期回复。更重要的是，我试图确保在评论中没有人互相交谈（这在问题讨论中很常见）。我也寻找那些包含行为准则的项目，这些准则列出了在在线互动中哪些行为是合适的，哪些是不合适的。

### 明确的贡献准则

因为这是我第一次为开源项目做出贡献，在此过程中我有很多问题。一些项目社区非常擅长记录选择问题和提出请求的程序。一些项目社区在记录流程方面很优秀，可以用来挑选其中的项目并提交请求。尽管那时我没有选择它们，因为在此之前我从未使用过该产品，Gatsby是该实践的一个范例。
