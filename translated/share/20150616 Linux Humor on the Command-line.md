Linux命令行中的幽默
================================================================================
桌面通常是非常养眼的，它增强了可视化的体验，有时也能够增强某些软件的功能，而且让软件变得更有趣。在命令行下工作也不需要总是很严肃，如果您想在命令行下找些乐子，那么有很多命令可以让您展露微笑。

Linux是个有趣的操作系统。它提供大量的小型开源工具，从平淡无奇的软件到稀奇古怪的应用。正是这些工具的质量和可选择性帮助Linux脱颖而出。让我们一起来看看下面这七个小工具吧。

### lolcat ###

![lolcat](http://www.linuxlinks.com/portal/content/reviews/Misc/Screenshot-lolcat.png)

lolcat是一个连接文件或标准输入到标准输出（类似一般的cat）的程序，它会为输出添加七彩的颜色。
