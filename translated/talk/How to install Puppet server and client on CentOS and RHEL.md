...
有时候你需要更复杂的 manifest 文件，在你着手编写它们之前，你有必要花点儿时间浏览一下 [https://forge.puppetlabs.com][2]。Forge 是一个集合了 Puppet 社区各个板块的网站，你的问题很可能已经有人解答过了，你能在那儿找到答案。如果找不到，那就自己写一个然后提交上去，其他人也能从中获益。
