...
让每个人感到幸运的是，这个不断采用新技术 的网站仍然很强大。我希望看到它继续存在下去，让新社区成员在需要时得到帮助。
...
Mike Horne（Recantha）是英国一位重要的树莓派社区成员，负责  [CamJam 和 Potton Pi＆Pint][2]（剑桥的两个树莓派社团）和 [Pi Wars][3] （一年一度的树莓派机器人竞赛）。他为其他人建立树莓派社团提供建议，并且总是有时间帮助初学者。Horne和他的共同组织者 Tim Richardson 一起开发了 CamJam Edu Kit （一系列小巧且价格合理的套件，适合初学者使用 Python 学习物理计算）。
...
Alex的网站 [RasP.iO][10] 制作了一系列树莓派附加板和配件，包括方便的 GPIO 端口引脚，电路板测量尺等等。他的博客也拓展到了 [Arduino][11]，[WEMO][12] 以及其他小网站。
...
Pimoroni 是一家世界知名的树莓派经销商，其总部位于英国谢菲尔德。他制作了著名的 [树莓派彩虹保护壳][14]，并推出了许多极好的定制附加板和配件。
