...
开源技术提供企业级的可扩展性、性能、安全性和可靠性。信任就在那里，而且是当之无愧的。但除了顽固的开源信徒之外，较少被人称道的是日常社区贡献的内部运作，在原子级别建立了这些宏观利益。对于那些提供开源技术的人来说，社区不断的用户驱动的测试和加固将这些技术锻造成强大和成熟的解决方案。Crate.io 的联合创始人 [Bernd Dorn][5] 写道，该组织从“开放核心”转变为采用 Apache 2.0 许可的纯开源。
