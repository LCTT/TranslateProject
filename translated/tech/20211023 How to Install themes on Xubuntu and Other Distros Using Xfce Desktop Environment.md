...
如何在 Xubuntu 和其他发行版上使用 Xfce 桌面环境安装主题
======

_**简介：这是一个循序渐进的初学者教程，展示了如何在 Xubuntu 和其他使用 Xfce 桌面环境的 Linux 发行版中安装主题和图标。**_
...
或者，你可以探索一些最好的[可用于 Ubuntu 的图标主题][12]，它们应该也适用于 Xubuntu。
