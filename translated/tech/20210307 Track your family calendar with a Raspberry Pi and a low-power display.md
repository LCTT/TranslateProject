...
这个项目是作为假日项目开始，因此我试着尽可能多的旧物利用。其中包括一台已经闲置了太长时间树莓派 2。由于我没有电子水墨屏，因此我需要购买一个。幸运的是，我找到了一家供应商，该供应商为树莓派的屏幕提供了 [开源驱动程序和示例][4]，该屏幕使用 [GPIO][5] 端口连接。
...
对我而言，这个项目让我感受到开源的力量。如果没有开源的驱动程序、库以及API，我们依旧还在用纸和笔来安排日程。很疯狂，不是吗？
