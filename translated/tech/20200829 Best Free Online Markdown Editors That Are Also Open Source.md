...
它支持 Markdown，可以让 [Mastodon][13]、[ActivityPub][14] 和 [Pleroma][15] 上的任何人轻松关注和分享你的博客文章。
...
考虑到很多在线编辑器、CMS 和记事本服务都支持 Markdown，如果你想把它发布到网站上，像 [WordPress][37] 这样的服务/应用也是一个不错的选择。
