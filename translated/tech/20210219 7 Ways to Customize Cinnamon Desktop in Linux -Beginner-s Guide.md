...
在 Linux 中自定义 Cinnamon 桌面的 7 种方法（初学者指南）
======
...
在本教程中，我使用的是 [Linux Mint Debian Edition][5]（LMDE 4）。你可以在任何运行 Cinnamon 的 Linux 发行版上使用。如果你不确定，这里有[如何检查你使用的桌面环境][6]。

当需要改变 Cinnamon 桌面外观时，我发现非常简单，因为只需点击两下即可。如下图所示，点击菜单图标，然后点击设置。

![][7]

所有的外观设置都放在窗口的顶部。在“系统设置”窗口上的一切都显得整齐划一。
...
我没有讲得太详细，但给了你足够的指导，让你自己去探索设置。欢迎反馈你的 Cinnamon 自定义。
