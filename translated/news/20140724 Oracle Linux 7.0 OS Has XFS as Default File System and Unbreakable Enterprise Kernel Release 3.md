...
为了这次新的发行版，Oracle的开发者们已经放出过两个预览版，现在最终版终于来了。果然，它有着成千上万的修改，其中包括新的XFS作为默认的文件系统[注：原文为操作系统，应该是笔误]，Btrfs作为可选文件系统，Linux Containers (LXC)， DTrace，Ksplice，加强版Xen和“第三代坚不可摧的企业级内核”。
...
“当发布最新的Linux更新，工具以及推送给客户和参与者新功能的时候，需要为了现代的数据中心提供企业级的解决方案，为此最新的发布版是构建在Oracle对于像OpenStack这样的新兴技术提供支持的基础上，”从官方声明可以看出。
...
译者：[Jelly](https://github.com/guodongxiaren) 校对：[校对者ID](https://github.com/校对者ID)
