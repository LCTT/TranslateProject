...
虽然许多Linux发行版为树莓派提供了许多系统镜像文件，但树莓派基金会保留了官方操作系统，我们便称之为树莓派操作系统。
如果你不知道，树莓派操作系统是基于Linux发行版Debian。具体来说，以Debian 11作为是当前树莓派操作系统最核心、轻量级版本并使用了LXDE作为其桌面应用环境。
### 树莓派操作系统：带来了什么最新内容？
...
官方发行说明包括更多详细信息，如果您想了解有关该版本的更多信息。
### 获取更多的树莓派操作系统
